			...
			"/be/": [
				{
					...
					items: [
						{ text: "后端组简介", link: "/be/" },
						{ text: "团队成员", link: "/be/team/team" },
						{ text: "大一上学期", link: "/be/freshmen_fall/freshmen_fall" },
						{ text: "大一下学期", link: "/be/freshmen_spring/freshmen_spring" },
						{ text: "大二上学期", link: "/be/sophomore_fall/sophomore_fall" },
					],
				},
			],
			"/mobile/": [
